...
const AssetDistribution = () => {
    return <div className='asset-distribution'>
        <div className="date-updated">
            <div className="dot"></div>
            <div className="text">更新时间：2025-10-11 08:50:56</div>
        </div>
        <div className="chart-metrics" style={{
            ...
            <div>
                ...
                <Metric2 value='1440.20' tagValue='819' tagUnit='座'></Metric2>
                ...
                <Metric2 value='144.20' tagValue='123' tagUnit='座'></Metric2>
                
                <div className='legend'>
                    <div className='box yellow'></div>
                    <div className='title'>光伏场</div>
                </div>
                <Metric2 value='1262.80' tagValue='76' tagUnit='座'></Metric2>
            </div>
        </div>
    </div>
}
