...
const MainPage = () => {
    ...
    return <div className='sx-main-page sx-page'>
        <div className="sx-main-page-content">
            <div className="content">
                <div className="left">
                    <SectionBox title='资产分布' content={<AssetDistribution />}  style={{ flex: 1 }}></SectionBox>
                    <SectionBox title='设备情况' content={<DeviceSituation />} style={{ flex: 1 }}></SectionBox>
                </div>
                <div className="center">
                    <div className="metric-list">
                        <Metric1 label="完整性" value='65.12%' onClick={()=>
                            location.href = '/#/case'
                        }></Metric1>
                        <Metric1 label="完整性" value='65.12%'></Metric1>
                        <Metric1 label="完整性" value='65.12%'></Metric1>
                        <Metric1 label="完整性" value='65.12%'></Metric1>
                        <Metric1 label="完整性" value='65.12%'></Metric1>
                    </div>
                    <SectionBox style={{ overflow: 'hidden', flex: 1 }} title='区域数据质量' content={<RegionalDataQuality></RegionalDataQuality>}></SectionBox>
                </div>
            </div>
