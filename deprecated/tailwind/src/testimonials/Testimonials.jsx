...
export default ({
  ...
  return (
    <section className='relative isolate overflow-hidden bg-white px-6 py-6'>
      ...
      <div className='mx-auto max-w-2xl lg:max-w-4xl'>
        ...
        {companyLogo && <img className='mx-auto h-12' src={companyLogo} alt='' />}
        <figure className='mt-6'>
          <blockquote className='text-center text-xl font-semibold leading-8 text-gray-900 sm:text-2xl sm:leading-9'>
            <p>{testimonials ?? ''}</p>
          </blockquote>
          <figcaption className='mt-3'>
            <img className='mx-auto h-20 w-20 rounded-full' src={userAvatar} alt='' />
