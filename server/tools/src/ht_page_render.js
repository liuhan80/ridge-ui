 ...
 * @class
 */
module.exports = class HTPageRender {
  /**
     * @constructor
  ...
  interpretVariableDependency () {
    const dependencies = {}
    const variableEvaluatedNodes = {}
    const nodesVisible = {}
    const nodePropertiesDynamicBindings = {}
    ...
    for (const node of this.flaternedElements) {
      ...
      const propWithExpressionValue = this.getNodePropertyExpression(node.db)
